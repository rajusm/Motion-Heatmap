# Run => python motion_heatmap.py --input input.mp4 --output input.jpg
...
def motion_heatmap(args):
    ...
    print("Video start {}".format(start_time))
    ...
    print("Video write to {}".format(args["output"]))
    print("Video end time {}".format(end_time))
